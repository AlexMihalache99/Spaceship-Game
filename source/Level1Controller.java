...
/**
 * The controller class for the level 1 button.
...
public class Level1Controller {
	...
	/**
	 * Displays the top 3 players of the level from leaderboard1.txt
    ...
    public void showButton(ActionEvent event) {
	    ...
	    try {
	    	br = new BufferedReader(new FileReader("leaderboard1.txt"));
